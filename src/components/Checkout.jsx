...
function Checkout() {
  ...
  useEffect(() => {
    ...
    axios.get("https://greencart-backend-z9tq.onrender.com/api/orders/next-id").then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://greencart-backend-z9tq.onrender.com/api/orders/create", formData);
